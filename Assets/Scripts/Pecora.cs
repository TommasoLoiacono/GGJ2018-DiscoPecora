...
public class Pecora : MonoBehaviour {
    ...
    public CaratteristicaEreditaria colorePelle = new CaratteristicaEreditaria(); // Il colore della pelle della pecora. Se non ci eri arrivato leggendo l'identificativo probabilmente dovresti cambiare mestiere
    public CaratteristicaEreditaria coloreLana = new CaratteristicaEreditaria(); // Il colore della lana della pecora. Impressionante vero?
    public CaratteristicaEreditaria carattere = new CaratteristicaEreditaria(); // Ogni pecora ha il suo carattere. Tu che stai leggendo ad esempio, che carattere hai?
